...
const DailyFire = () => {
  ...
  return (
    <div className="animate-fade-in">
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-flame-50 via-orange-50 to-yellow-50 dark:from-flame-900/30 dark:via-orange-900/30 dark:to-yellow-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-float mb-4 sm:mb-6">
            <Sunrise className="h-12 w-12 sm:h-14 sm:w-14 lg:h-16 lg:w-16 text-flame-500 mx-auto" />
          </div>
          ...
          <div className="mt-6 sm:mt-8 bg-white dark:bg-gray-800 rounded-xl p-3 sm:p-4 shadow-lg">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-flame-50 to-orange-50 dark:from-flame-900/30 dark:to-orange-900/30 rounded-2xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12">
            <div className="flex items-center justify-center mb-4 sm:mb-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-flame-500 rounded-full flex items-center justify-center">
                <Heart className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
              </div>
            </div>

            <h2 className="font-serif text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-3 sm:mb-4 text-center">
              Today's Fire
            </h2>

            <article className="prose prose-base sm:prose-lg max-w-none">
              <h3 className="font-serif text-xl sm:text-2xl font-semibold text-flame-700 dark:text-flame-300 mb-3 sm:mb-4">
                {todaysDevotional.title}
              </h3>

              <blockquote className="border-l-4 border-flame-300 pl-4 sm:pl-6 mb-4 sm:mb-6 bg-white dark:bg-gray-800 rounded-r-lg p-3 sm:p-4">
                <p className="font-serif text-base sm:text-lg text-gray-700 dark:text-gray-200 italic mb-2">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3 sm:p-4">
                <h4 className="font-semibold text-gray-800 dark:text-white mb-2 text-sm sm:text-base">Prayer for Today:</h4>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Link key={devotional.id} href={`/daily-fire/${devotional.id}`}>
                <article className="bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden cursor-pointer">
                  <div className="p-4 sm:p-6">
                    ...
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed mb-3 sm:mb-4">{devotional.message[0].substring(0, 150)}...</p>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-flame-600 dark:text-flame-400 hover:text-flame-700 dark:hover:text-flame-300 font-medium text-sm sm:text-base flex items-center group">
                        Read More
          ...
          <div className="text-center mt-8 sm:mt-12">
            <button
              ...
              className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium text-sm sm:text-base py-2.5 sm:py-3 px-6 sm:px-8 rounded-full border-2 border-gray-200 dark:border-gray-600 hover:border-flame-300 dark:hover:border-flame-600 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((category, index) => (
              <div key={index} className="group cursor-pointer">
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 hover:from-flame-50 hover:to-flame-100 dark:hover:from-flame-900/30 dark:hover:to-flame-800/30 rounded-xl p-4 sm:p-5 lg:p-6 transition-all duration-300 transform hover:-translate-y-1 border-2 border-transparent hover:border-flame-200 dark:hover:border-flame-700">
                  <h3 className="font-serif text-base sm:text-lg font-semibold text-gray-800 dark:text-white group-hover:text-flame-700 dark:group-hover:text-flame-300 mb-1 sm:mb-2">
                    {category.name}
                  </h3>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-gray-900 dark:bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Calendar className="h-10 w-10 sm:h-12 sm:w-12 text-flame-400 mx-auto mb-4 sm:mb-6" />
      ...
      <section className="py-16 bg-gradient-to-br from-sky-50 to-flame-50 dark:from-sky-900/30 dark:to-flame-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg">
            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-200 italic font-medium">
