...
const MinistryHub = () => {
  ...
  return (
    <div className="animate-fade-in">
      {/* Hero Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-sky-50 to-flame-50 dark:from-sky-900/30 dark:to-flame-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Globe className="h-12 w-12 sm:h-14 sm:w-14 lg:h-16 lg:w-16 text-flame-500 mx-auto mb-4 sm:mb-6" />
              ...
              <div key={index} className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="lg:w-2/3 p-8">
                    ...
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed mb-4 sm:mb-6">{ministry.description}</p>
                    
                    <div>
                      <h4 className="font-semibold text-gray-800 dark:text-white mb-2 sm:mb-3 text-sm sm:text-base">Key Features:</h4>
      ...
      {/* Important Note */}
      <section className="py-10 sm:py-12 lg:py-16 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border-t-2 border-b-2 border-yellow-200 dark:border-yellow-700">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 lg:p-8 border-l-4 border-yellow-400 dark:border-yellow-600 shadow-lg">
            <h2 className="font-serif text-xl sm:text-2xl font-bold text-yellow-800 dark:text-yellow-300 mb-3 sm:mb-4 text-center">Important Note</h2>
            <p className="text-yellow-700 dark:text-yellow-300 text-base sm:text-lg text-center leading-relaxed">
      ...
      {/* Crisis Resources */}
      <section className="py-10 sm:py-12 lg:py-16 bg-red-50 dark:bg-red-900/20 border-t-4 border-red-200 dark:border-red-700">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6 text-center">
            Crisis Support Resources
          </h2>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg mb-4 sm:mb-6">
            ...
            <div>
              <h3 className="font-semibold text-base sm:text-lg text-gray-800 dark:text-white mb-3 sm:mb-4 text-center">Australia</h3>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-gradient-to-br from-sky-50 to-flame-50 dark:from-sky-900/30 dark:to-flame-900/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Book className="h-10 w-10 sm:h-12 sm:w-12 text-sky-600 dark:text-sky-400 mx-auto mb-4 sm:mb-6" />
