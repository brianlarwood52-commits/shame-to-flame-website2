          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg border border-white/20 dark:border-gray-700/50">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-flame-100 dark:bg-flame-900/50 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Star className="h-5 w-5 sm:h-6 sm:w-6 text-flame-600 dark:text-flame-400" />
              </div>
              <h3 className="font-serif text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mb-2 sm:mb-3 text-center">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg border border-white/20 dark:border-gray-700/50">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-sky-100 dark:bg-sky-900/50 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Heart className="h-5 w-5 sm:h-6 sm:w-6 text-sky-600 dark:text-sky-400" />
              </div>
              <h3 className="font-serif text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mb-2 sm:mb-3 text-center">
      ...
      <section className="py-16 bg-gray-900/90 dark:bg-black/90 backdrop-blur-md text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <button className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-flame-600/90 hover:bg-flame-700 backdrop-blur-sm text-white text-sm sm:text-base font-medium rounded-full transition-all duration-300 transform hover:scale-105 border border-flame-500/50">
              <Download className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
              Download Preview (PDF)
            </button>
            <button className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-white/30 hover:bg-white/10 hover:border-white/50 backdrop-blur-sm text-white text-sm sm:text-base font-medium rounded-full transition-all duration-300">
