        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <div className="text-center">
              ...
              <h3 className="font-serif text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mb-2">Choose Your Path</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-serif text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mb-2">Track Progress</h3>
            ...
            {healingPathways.map((pathway) => {
              ...
              return (
                <div key={pathway.id} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-white/20 dark:border-gray-700/50">
                  <div className={`h-24 sm:h-28 lg:h-32 bg-gradient-to-br ${getColorClasses(pathway.color)} flex items-center justify-center`}>
                    <IconComponent className="h-10 w-10 sm:h-12 sm:w-12 text-white" />
                  </div>
                  
                  <div className="p-4 sm:p-5 lg:p-6">
                    <div className="flex items-center justify-between mb-2 sm:mb-3">
                      <h3 className="font-serif text-lg sm:text-xl font-semibold text-gray-800 dark:text-white">
                        {pathway.title}
                      </h3>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            <div className="bg-gradient-to-br from-sky-50/90 to-sky-100/90 dark:from-sky-900/30 dark:to-sky-800/30 backdrop-blur-sm rounded-xl p-4 sm:p-5 lg:p-6 border border-sky-200/50 dark:border-sky-700/50">
              <h3 className="font-serif text-xl sm:text-2xl font-semibold text-sky-700 dark:text-sky-300 mb-3 sm:mb-4">Quick Start Guides</h3>
            ...
            <div className="bg-gradient-to-br from-flame-50/90 to-flame-100/90 dark:from-flame-900/30 dark:to-flame-800/30 backdrop-blur-sm rounded-xl p-4 sm:p-5 lg:p-6 border border-flame-200/50 dark:border-flame-700/50">
              <h3 className="font-serif text-xl sm:text-2xl font-semibold text-flame-700 dark:text-flame-300 mb-3 sm:mb-4">Support Groups</h3>
              <p className="text-gray-700 dark:text-gray-200 mb-4">
