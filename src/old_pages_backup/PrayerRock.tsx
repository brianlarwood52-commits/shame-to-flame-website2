...
const PrayerRock = () => {
  ...
  return (
    <div className="animate-fade-in">
      {/* Hero Section */}
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-float mb-4 sm:mb-6">
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-flame-400 to-flame-600 rounded-full shadow-lg">
              <BookOpen className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
            </div>
          </div>
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6">
            Prayer Rock Archive
          </h1>
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto mb-6 sm:mb-8">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl p-4 sm:p-5 lg:p-6 border border-white/20 dark:border-gray-700/50 max-w-2xl mx-auto">
            <div className="text-gray-700 dark:text-gray-200 leading-relaxed text-sm sm:text-base">
              <h3 className="font-serif text-lg sm:text-xl font-semibold text-flame-700 dark:text-flame-300 mb-3 sm:mb-4">
      ...
      {activeTab === 'blog' ? (
        <>
          ...
          <section className="py-10 sm:py-12 lg:py-16 bg-gradient-to-r from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-md">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-8 sm:mb-12 text-center">
                All Reflections
              </h2>
        ...
        <>
          ...
          <section className="py-10 sm:py-12 lg:py-16 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="bg-gradient-to-br from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12 border border-white/20 dark:border-gray-700/50">
                <div className="text-center mb-4 sm:mb-6">
                  <Heart className="h-10 w-10 sm:h-12 sm:w-12 text-flame-500 mx-auto mb-3 sm:mb-4" />
                  <h2 className="font-serif text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white">Prayer of the Week</h2>
                </div>
                
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg border border-white/20 dark:border-gray-700/50">
                  <h3 className="font-serif text-xl sm:text-2xl font-semibold text-flame-700 dark:text-flame-300 mb-3 sm:mb-4 text-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                {prayerCategories.map((category, index) => (
                  <div key={index} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden group cursor-pointer border border-white/20 dark:border-gray-700/50">
                    <div className={`h-24 sm:h-28 lg:h-32 bg-gradient-to-br ${getColorClasses(category.color)} flex items-center justify-center`}>
                      <category.icon className="h-10 w-10 sm:h-12 sm:w-12 text-white" />
                    </div>
                    
                    <div className="p-4 sm:p-5 lg:p-6">
                      <h3 className="font-serif text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mb-2 sm:mb-3 group-hover:text-flame-600 dark:group-hover:text-flame-400 transition-colors duration-200">
                        {category.title}
                      </h3>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                {testimonies.map((testimony, index) => (
                  <div key={index} className="bg-gradient-to-br from-gray-50/90 to-gray-100/90 dark:from-gray-800/80 dark:to-gray-700/80 backdrop-blur-md rounded-xl p-4 sm:p-5 lg:p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-white/20 dark:border-gray-700/50">
              ...
              <div className="text-center mt-8 sm:mt-12">
                <button className="bg-flame-600 hover:bg-flame-700 text-white text-sm sm:text-base font-medium py-2.5 sm:py-3 px-6 sm:px-8 rounded-full transition-all duration-300 transform hover:scale-105">
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-gradient-to-br from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 border border-white/20 dark:border-gray-700/50">
            <div className="text-center mb-6 sm:mb-8">
              <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-sky-400 to-sky-600 rounded-full mb-3 sm:mb-4">
                <Heart className="h-7 w-7 sm:h-8 sm:w-8 text-white" />
              </div>
              <h2 className="font-serif text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-3 sm:mb-4">
      ...
      {/* Community Impact */}
      <section className="py-10 sm:py-12 lg:py-16 bg-gray-900/90 dark:bg-black/90 backdrop-blur-md text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-flame-400 mb-2">500+</div>
              <p className="text-gray-300">Prayer Requests</p>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-sky-400 mb-2">1,200+</div>
              <p className="text-sm sm:text-base text-gray-300">Prayers Offered</p>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-sage-400 mb-2">150+</div>
              <p className="text-sm sm:text-base text-gray-300">Answered Prayers</p>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold text-yellow-400 mb-2">50+</div>
              <p className="text-sm sm:text-base text-gray-300">Reflections Shared</p>
            </div>
          </div>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-gradient-to-br from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <BookOpen className="h-10 w-10 sm:h-12 sm:w-12 text-sky-600 dark:text-sky-400 mx-auto mb-4 sm:mb-6" />
