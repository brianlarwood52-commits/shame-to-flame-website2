...
const CrisisHelp = () => {
  return (
    <div className="animate-fade-in">
      <section id="emergency" className="pt-16 sm:pt-20 lg:pt-24 pb-10 sm:pb-12 lg:pb-16 bg-red-50 dark:bg-red-900/20 border-t-4 border-red-200 dark:border-red-700">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-6 shadow-lg mb-4 sm:mb-6">
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="font-semibold text-base sm:text-lg text-gray-800 dark:text-white mb-3 sm:mb-4 text-center">United States</h3>
