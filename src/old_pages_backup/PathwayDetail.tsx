        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="lg:col-span-2">
              <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-3 sm:mb-4">
                {pathway.title}
              </h1>
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-4 sm:mb-6">
                {pathway.description}
              </p>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl p-4 sm:p-5 lg:p-6 border border-white/20 dark:border-gray-700/50">
                <h3 className="font-serif text-lg sm:text-xl font-semibold text-gray-800 dark:text-white mb-3 sm:mb-4">
                  Your Progress
                </h3>
