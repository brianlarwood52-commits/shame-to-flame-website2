    ...
    <div className="min-h-screen pt-16">
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FileText className="h-12 w-12 sm:h-14 sm:w-14 lg:h-16 lg:w-16 text-flame-500 mx-auto mb-4 sm:mb-6" />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 sm:space-y-10 lg:space-y-12">
            {sitePages.map((section, index) => (
              <div key={index}>
                <h2 className="font-serif text-xl sm:text-2xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6 pb-2 border-b-2 border-flame-500/30">
                  {section.title}
                </h2>
                <div className="grid gap-3 sm:gap-4">
                  {section.pages.map((page, pageIndex) => (
                    <Link
                      key={pageIndex}
                      href={page.url}
                      className="block p-3 sm:p-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-700 hover:border-flame-500 dark:hover:border-flame-500 hover:shadow-md transition-all duration-200 group"
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          <h3 className="font-semibold text-base sm:text-lg text-gray-800 dark:text-white group-hover:text-flame-600 dark:group-hover:text-flame-400 transition-colors">
                            {page.name}
                          </h3>
                        ...
                        <span className="text-flame-600 dark:text-flame-400 text-sm font-medium group-hover:translate-x-1 transition-transform ml-2">
                          →
                        </span>
                      </div>
      ...
      <section className="py-10 sm:py-12 lg:py-16 bg-gradient-to-r from-sky-50/90 to-flame-50/90 dark:from-sky-900/30 dark:to-flame-900/30 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base bg-flame-600/90 hover:bg-flame-700 backdrop-blur-sm text-white font-medium rounded-full transition-all duration-300 transform hover:scale-105 border border-flame-500/50"
          >
            Contact Us
          </Link>
        </div>
